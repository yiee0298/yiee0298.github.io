...
const data_url =
  "https://api.mapbox.com/datasets/v1/yiee0298/cm6glqeyq0l0a1orto39ckn98/features?access_token=pk.eyJ1IjoieWllZTAyOTgiLCJhIjoiY201d2Y4eW9uMGQycTJrcXpjNjY2bm92MSJ9.KM7XU1SW7BQPbp1X9_H8GA";
...
map.on("load", () => {
  ...
  document.getElementById("filters").addEventListener("change", (event) => {
    ...
    // Ensure filterMonth is defined before using it
    if (typeof filterMonth === "undefined") {
      // Set a default filter if filterMonth is not defined
